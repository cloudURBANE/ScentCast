...
export async function buildProfile(
  ...
  const parsed = parseFragrance({ name: finalName, brand: finalBrand, notes: finalNotes, family: finalFamily, description: finalDescription } as FragranceData);
  ...
  return {
    product: { name: finalName, brand: finalBrand },
    scent_vector: vector,
    performance,
    context,
    notes: finalNotes,
